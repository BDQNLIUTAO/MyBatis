                ...
                $.ajax({
                    ...
                    success:function (data) {
                        ...
                        $.each(data.list,function (i,dom) {
                            ...
                            //一个dom就是一个用户对象
                            $("#list-content").append("<tr><td>"+dom.userCode+"</td><td>"+dom.userName+"</td><td>"+(dom.gender==1?'男':'女')+"</td><td>"+jsGetAge(dom.birthday)+"</td><td>"+dom.phone+"</td><td>"+dom.type+"</td><td><a href='userView.html'><img src='/pages/img/read.png' alt='查看' title='查看'/></a><a href='userUpdate.html'><img src='/pages/img/xiugai.png' alt='修改' title='修改'/></a> <a href='#' class='removeUser'><img src='/pages/img/schu.png' alt='删除' title='删除'/></a></td></tr>")
                        });
                        //渲染分页
                        $('#pagination').pagination({
                            ...
                            pageSize:"",
                            pageList:[2,3,5,10],
                            onSelectPage:function(pageNumber){  //pageNumber:第几页  pageSize:每页显示的数据库
                                load(pageNumber-1);
                            }
                        })
                    }
